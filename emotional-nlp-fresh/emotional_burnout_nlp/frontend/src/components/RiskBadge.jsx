const RISK_STYLES = {
  Low:      { color: '#0891b2', bg: '#22d3ee10', border: '#22d3ee40', shadow: '0 0 12px #22d3ee30', label: 'LOW RISK' },
  Medium:   { color: '#b45309', bg: '#fbbf2410', border: '#fbbf2440', shadow: '0 0 12px #fbbf2430', label: 'MEDIUM RISK' },
  High:     { color: '#dc2626', bg: '#f8717110', border: '#f8717140', shadow: '0 0 12px #f8717130', label: 'HIGH RISK' },
